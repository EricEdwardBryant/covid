...
x <-
  ...
  mutate(
    norm_cases = 
      ...
      max(`Smooth estimate` - min(`Smooth estimate`, na.rm = TRUE), na.rm = TRUE),
    norm_hsp   =
      (Hospitalized - min(`Hospitalized`, na.rm = TRUE)) /
      max(Hospitalized - min(Hospitalized, na.rm = TRUE), na.rm = TRUE),
    norm_icu   =
      (ICU - min(ICU, na.rm = TRUE)) /
      max(ICU - min(ICU, na.rm = TRUE), na.rm = TRUE),
