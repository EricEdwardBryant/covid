...
df_data %>%
  ...
  gt::gt() %>%
  gt::fmt_number(columns = c(`Hospitalized`, ICU, `New deaths`, `New cases`, `Death estimate`, `Smooth estimate`, `2 week median`, `Daily change`, `Weekly change`), decimal = 0) %>%
...
x %>%
  ...
  scale_color_manual(values = c("blue", "gold2", "maroon2", "olivedrab")) +
  scale_x_date(
    date_breaks = "4 month",
    date_labels = "%b",
