...
download_new_cases_ca(csv_cases)
download_hospitalization_ca(csv_hsp)
```
...
```{r new-cases-los-angeles, fig.height = 7}
county <- "Los Angeles"

figure_new_cases(csv_cases, county, population = la_population) /
  figure_new_cases_change(csv_cases, county) /
  figure_hospitalization(csv_hsp, county)
```
...
```{r new-cases-santa-clara, fig.height = 7}
county <- "Santa Clara"

figure_new_cases(csv_cases, county, population = sc_population) /
  figure_new_cases_change(csv_cases, county) / 
  figure_hospitalization(csv_hsp, county)
```
